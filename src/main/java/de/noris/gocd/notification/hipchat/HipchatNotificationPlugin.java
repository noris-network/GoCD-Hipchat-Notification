...
import de.noris.gocd.notification.hipchat.executors.GetPluginConfigurationExecutor;
import de.noris.gocd.notification.hipchat.executors.GetViewRequestExecutor;
import de.noris.gocd.notification.hipchat.executors.NotificationInterestedInExecutor;
...
@Extension
public class HipchatNotificationPlugin implements GoPlugin {

    public static final Logger LOG = Logger.getLoggerFor(HipchatNotificationPlugin.class);
